...
- Suggest updates to Layer 1 assets (.cursorrules, plan templates, commands)
...
.cursor/commands/rpiv-core-loop/plan.md

**Generated Plan:**
Read this to understand what was SUPPOSED to be done.
Plan file: $1

**Execute Command:**
Read this to understand the execution process and what instructions guide implementation.
.cursor/commands/rpiv-core-loop/implement.md

**Execution Report:**
Read this to understand what was ACTUALLY done and why.
Execution report: $2
...
- **.cursorrules updates:** Universal patterns or anti-patterns to document
...
Save your analysis to: `.cursor/reviews/[feature-name]-review.md`
...
reason: [stated reason from report]
...
- [ ] Used documented patterns (from .cursorrules)
...
- **Suggest improvements:** Don't just analyze - actually suggest the text to add to .cursorrules or commands