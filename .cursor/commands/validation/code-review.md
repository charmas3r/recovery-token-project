...
- `.cursorrules` - Project-wide coding standards and conventions
- `README.md` - Project overview and setup instructions
- `.cursor/skills/` - Domain-specific standards for relevant areas (check skill folders that match the code being reviewed)
- `.cursor/docs/references/` - Technical documentation and feature summarizations
...
5. **Adherence to Codebase Standards and Existing Patterns**
   - Adherence to `.cursorrules` project conventions
   - Adherence to relevant skill standards in `.cursor/skills/` (check skills that match the code being reviewed)
...
Save a new file to `.cursor/code-reviews/[appropriate-name].md`
